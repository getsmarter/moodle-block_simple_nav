...
class block_simple_nav_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        foreach ($this->categories as $category) {
            // change the value here if you want to control more of the subcategories etc. After
            // changing the value, you have to check if everything is displayed as you want. It
            // might be necessary to reinstall the whole block (especially when you decrease the
            // value)
            if ($category->depth <= 6) {
